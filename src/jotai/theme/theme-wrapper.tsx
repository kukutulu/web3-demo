import { alpha, createTheme, CssBaseline, darken, responsiveFontSizes, ThemeOptions, ThemeProvider } from '@mui/material';
...
function switchTheme(theme: THEME_MODE, darkMode: string, lightMode: string) {
  ...
  const theme = useMemo(() => {
    return createTheme({
      ...
      palette: {
        mode: mode,
        background: {
          paper: switchTheme(mode, '#091C34', '#FFFFFF'),
          secondary: '#021C39',
          primary: switchTheme(mode, '#07111C', '#021C39'),
        },
        // gradient: {
        ...
        primary: {
          light: '#ffffff',
          main: '#1C8CF3',
          dark: switchTheme(mode, '#D7DFEC', '#131C23'),
        },
        secondary: {
          main: switchTheme(mode, '#001229', '#FFFFFF'),
        },
        info: {
          main: '#EAF3FF',
        },
        ...
        text: {
          primary: switchTheme(mode, '#FFFFFF', '#021C39'),
          secondary: switchTheme(mode, '#7994C1', '#41556B'),
          disabled: switchTheme(mode, '#7994C1', '#021C39'),
          header: switchTheme(mode, '#CCCFD2', '#5B6B7D'),
          header1: switchTheme(mode, '#FFFFFF', '#41556B'),
        },
      },
      typography: {
